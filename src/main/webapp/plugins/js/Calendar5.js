...
str += '.calendar{position:absolute;width:154px!important;width /**/:154px;height:204px!important;height /**/:174px;background-color:'+this.style.bodyBackColor+';border:2px solid ' + this.style.borderColor + ';left:0px;top:0px;z-index:9999;}\n';
str += '.cdrHeader{background-color:'+ this.style.headerBackColor +';width:154px;height:22px;font-size:12px;color:'+this.style.headerFontColor+';}\n';
str += '.cdrWatermark{position:absolute;left:0px;top:55px;width:154px;font-family: Arial Black;font-size:50px;color:'+this.style.watermarkColor+';z-index:1;text-align:center;}\n';
str += '.cdrBodyBar{background-color:' + this.style.bodyBarBackColor + ';font-size:12px;color:' + this.style.bodyBarFontColor + ';width:154px;height:20px;}\n';
str += '.cdrBody{width:154px;height:122px!important; height /**/:110px;font-size:12px;cursor:pointer;color:' + this.style.bodyFontColor + ';}\n';
...
str += 'html>body #Calendar{width:154px;174px;}';
str += '</style>\n';	
return str;
};
